 ...
 * @LastEditTime: 2026-01-28 16:06:14
 */
...
export const AIPanel: React.FC = () => {
  ...
  const { clearMessages, messages, isGenerating } = useAIStore()
  ...
  return (
    <>
      ...
      >
        {/* Header */}
        <div className="border-b border-gray-200 dark:border-gray-700 px-4 py-1.5 flex items-center justify-between bg-white dark:bg-gray-800">
          <h2 className="text-lg font-semibold text-gray-800 dark:text-gray-100">AI 助手</h2>
          <span className="flex gap-2">
            <button
              onClick={clearMessages}
              disabled={isGenerating || messages.length === 0}
              className="p-1 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-lg transition-colors cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed text-gray-600 dark:text-gray-400 hover:text-red-500"
              title="清空对话"
            >
